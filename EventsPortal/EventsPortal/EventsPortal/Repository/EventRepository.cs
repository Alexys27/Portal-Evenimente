        ...
        public EventModel GetEventsByID(Guid ID)
        {
            var eventModel = dbContext.Events
                ...
                .Select(e => new EventModel
                {
                    ...
                    // Include the names using join operations
                    LocationName = e.Location.LocationName, // Assuming Location has a Name property
                    SelectedPackageName = e.EventPackages.FirstOrDefault().Package.PackageName, // Assuming Package has a Name property
                    SelectedAdditionalServiceNames = e.EventServices.Select(es => es.Service.ServiceName).ToList() // Assuming AdditionalService has a Name property
                })
                .FirstOrDefault();
